...
NAPI exposes a set of APIs to interrogate and set properties on Javascript objects.
...
Fundamentally, all properties in NAPI can be represented in one of the following forms:
